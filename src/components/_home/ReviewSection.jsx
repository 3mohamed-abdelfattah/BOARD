    ...
    return (
        <main className='mt-20'>
            ...
            <section className='flex justify-center flex-wrap gap-5 mt-24'>
                ...
                {/* Card 1*/}
                <div className={styles.CardContainerStyle} data-aos="fade-right" data-aos-duration="1500">
                    {/* Review Info */}
                    <span>
                        <FiveStarIcon />
                ...
                {/* Card 2*/}
                <div className={styles.CardContainerStyle}data-aos="fade-left" data-aos-duration="1500">
                    {/* Review Info */}
                    <span>
                        <FiveStarIcon />
