    ...
    return (
        <main className='mt-20'>
            ...
            <header className='flex flex-col justify-center items-center gap-3 text-center'>
                <p className='Bungee_font text-5xl sm:text-7xl uppercase max-w-[718px]' data-aos="zoom-in" data-aos-duration="2500">
                    choose your <span className='background_text'>favorite</span> games
                </p>
                <p className='max-w-[518px] px-3' data-aos="zoom-in" data-aos-duration="2500">Offer sneak peeks and previews of upcoming games, including trailers, screenshots, and information about release.</p>
            </header>
            ...
            <section className='flex justify-between overflow-clip gap-3 sm:gap-9 items-baseline mt-5 sm:mt-10'>
                <div className='hidden sm:block' data-aos="fade-right" data-aos-duration="1500">
                    <img src={Game1} alt='Game Image' />
                </div>
                <div className='relative mx-5 sm:mx-0' data-aos="zoom-in" data-aos-duration="1500">
                ...
                <div className='hidden sm:block'>
                    <img src={Game3} alt='Game Image' data-aos="fade-left" data-aos-duration="1500" />
                </div>
            </section>
            ...
            <article className='flex justify-center w-full mt-10 sm:mt-28'>
                ...
                <div className='glass_effect relative flex flex-col-reverse lg:flex-row justify-between items-center py-0 lg:py-5 mx-5 xl:mx-36 w-full 2xl:h-[556px] rounded-xl border border-white/10'>
                    ...
                    <span className='flex flex-col p-5 lg:p-0 gap-5 sm:gap-10 xl:ml-20'>
                        <p data-aos="zoom-in" data-aos-duration="1500" className='Bungee_font lg:p-0 lg:max-w-[530px] vsm:text-3xl sm:text-5xl uppercase'>Discover the Virtual Reality Gaming </p>
                        <p data-aos="zoom-in" data-aos-duration="1500" className=' max-w-[460px] text-sm vsm:text-base'>A well-designed gaming header often incorporates elements such as game characters, iconic symbols, vibrant colors, and dynamic visuals to convey excitement, adventure, and the immersive nature of gaming.</p>
