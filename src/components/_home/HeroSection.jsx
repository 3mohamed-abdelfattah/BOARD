...
export const HeroSection = () => {
    ...
    return (
        <main className='overflow-hidden'>
            ...
            <img src={HeroImage} alt='Hero Image' className='background_image hidden lg:block absolute top-0 right-0 contrast-[1.15] -z-10' data-aos="fade-left" data-aos-duration="2500" />
            ...
            <section className={styles.InfoSectionStyle}>
                <span>
                    ...
                    <span className='flex flex-col gap-4'>
                        <p className='Bungee_font uppercase text-5xl sm:text-7xl px-3' data-aos="fade-right" data-aos-duration="1500">Let your <br /> mind <span className='background_text'>explore</span> new world</p>
                        <p className='sm:text-lg lg:max-w-2xl sm:leading-[34.642px] sm:tracking-[0.749px]' data-aos="fade-right" data-aos-duration="2500">Playing electronic games, whether through consoles, computers, mobile phones or another medium altogether. Gaming is a nuanced term that suggests regular game play, possibly as a hobby.</p>
                    </span>

                    {/* Buttons */}
                    <span className='Bungee_font flex justify-center lg:justify-normal uppercase text-xl mt-8' data-aos="fade-right" data-aos-duration="2500">
                    ...
                    <span className='flex justify-center lg:justify-normal text-xl mt-16 gap-8'>
                        ...
                        <span className='flex flex-col gap-1 items-center' data-aos="fade-right" data-aos-duration="1500">
